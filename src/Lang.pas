...
const
  ...
  Lang_RUS: array[0..14] of string = (
      ...
      'Êàðòà íå ñîçäàíà',                                // 2
      'Íå àêâèâíà',                                      // 3
      'Íå âîçìîæíî çàãðóçèòü ðåñóðñû',                   // 4
      'Ýòîò îáúåêò íå èìååò ñâÿçåé â JavaScript',        // 5
      'Id èç JavaScript íå êîððåêòíûé',                  // 6
      'JavaScript Id íå ñóùåñòâóåò',                     // 7
      'Íåêîððåêòíîå ÷èñëî ïàðàìåòðîâ',                   // 8
      'Íåêîððåêòíûé òèï ïàðàìåòðà',                      // 9
      'Íåêîððåêòíîå çíà÷åíèå ïàðàìåòðà',                 // 10
